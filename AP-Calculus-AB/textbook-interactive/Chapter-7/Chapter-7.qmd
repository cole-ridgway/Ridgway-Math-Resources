...
::: {.callout-note collapse="false" title="Area Between Two Curves Interactive Graph" icon=false}
Use the tool below to visualize the area between two curves and how it changes as you adjust the functions and limits of integration.
